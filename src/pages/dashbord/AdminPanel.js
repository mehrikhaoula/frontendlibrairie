        ...
        <div className='min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100'>
            ...
            <header className='bg-gradient-to-tr from-blue-950 to-white backdrop-blur-sm p-4 flex justify-between items-center md:hidden shadow-sm'>
                <div className='flex items-center'>
                    ...
                    <div className='ml-3'>
                        <p className='capitalize text-lg font-semibold text-gray-800'>Admin</p>
            ...
            {/* Sidebar */}
            <aside className={`bg-gradient-to-tr from-blue-950 to-white  backdrop-blur-sm min-h-full w-full max-w-64 md:block 
                ${isOpenMenu ? 'block' : 'hidden'} shadow-lg transition-all duration-300`}>
                <div className='flex flex-col items-center justify-center py-6 border-b border-gray-200'>
                    ...
                    <div className='text-center'>
                        <p className='capitalize text-xl font-semibold text-gray-800'>Admin</p>
                        <p className='text-sm text-gray-600'>admin@gmail.com</p>
                    </div>
                </div>
